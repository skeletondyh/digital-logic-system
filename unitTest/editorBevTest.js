   ...
   it("test file upload", function (done) {
       request.post('/file/uploadFile')
           ...
           .expect(200).end(function (err, res) {
            ...
            var fileList = fs.readdirSync("/home/yuhui/DC_Data/projectFile/5837fc81655e9b21d67d0f0f");
   ...
   it("test file rename", function(done){
       request.post("/file/uploadEditor")
           .send({
               ...
               filePath: "/home/yuhui/DC_Data/projectFile/5837fc81655e9b21d67d0f0f/testUploadFile.txt",
           ...
           .end(function (err, res) {
               ...
               var fileContent = fs.readFileSync("/home/yuhui/DC_Data/projectFile/5837fc81655e9b21d67d0f0f/testRenameFile.txt", "utf8");
    ...
    it("test getFileContent", function (done) {
        request.post('/editor/getFileContent')
            .send({
                path: "/home/yuhui/DC_Data/projectFile/5837fc81655e9b21d67d0f0f/testRenameFile.txt",
                projectId: "5837fc81655e9b21d67d0f0f"
            })
            .expect(200)
            .end(function (err, res) {
    ...
    it("test file delete",function (done) {
        request.post("/editor/deleteFile")
            .send({
                filePath: "/home/yuhui/DC_Data/projectFile/5837fc81655e9b21d67d0f0f/testRenameFile.txt",
                projectId: "5837fc81655e9b21d67d0f0f"
            })
            .expect(200)
            .end(function (err, res) {
