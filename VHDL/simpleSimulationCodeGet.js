...
function simulationCodeGenerator(prj, signal, editSignal, callback, flag, outputfile, homeworkID) {
...
use ieee.std_logic_arith.all;\n";
    ...
    if((flag == 0) || (flag == undefined))
        ...
        var vhdpath = '/home/yuhui/DC_Data/homeworkFile/' + homeworkID;
        fs.writeFile(path.join(vhdpath, outputfile+".vhd"), res, callback);  
    }
