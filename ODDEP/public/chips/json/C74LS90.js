var C74LS90 = draw2d.SetFigure.extend({
   ...
   init:function(attr, setter, getter)
   {
     ...
     var port;  // 以下为端口定义
     // Port
     port = this.addPort(new DecoratedInputPort(), new draw2d.layout.locator.XYRelPortLocator(13.698630136986301, 18.103448275862068));
     ...
     port.setMaxFanOut(20);
     // Port
     port = this.createPort("output", new draw2d.layout.locator.XYRelPortLocator(70.77625570776256, 18.103448275862068));
     port.setConnectionDirection(0);
     port.setBackgroundColor("#37B1DE");
     port.setName("port9");
     port.setMaxFanOut(20);
     ...
     port = this.addPort(new DecoratedInputPort(), new draw2d.layout.locator.XYRelPortLocator(70.77625570776256, 81.89655172413792));
     port.setConnectionDirection(2);
     port.setBackgroundColor("#37B1DE");
     port.setName("port6");
     port.setMaxFanOut(20);
     // Port
     port = this.addPort(new DecoratedInputPort(), new draw2d.layout.locator.XYRelPortLocator(82.1917808219178, 81.89655172413792));
     port.setConnectionDirection(2);
     port.setBackgroundColor("#37B1DE");
     port.setName("port7");
     port.setMaxFanOut(20);
   ...
   createSet: function()
   {
       this.canvas.paper.setStart();
        ...
        shape.attr({"x":76,"y":59.5,"text-anchor":"start","text":"74LS90","font-family":"\"Arial\"","font-size":15,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":0.75});
