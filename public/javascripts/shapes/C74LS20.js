...
var C74LS20 = draw2d.SetFigure.extend({            
       ...
       init:function(attr, setter, getter)
       {
         ...
         port.setMaxFanOut(20);
         // Port_2C
         port = this.addPort(new DecoratedInputPort(), new draw2d.layout.locator.XYRelPortLocator(100, 35.51136363636364));
         port.setConnectionDirection(1);
         port.setBackgroundColor("#37B1DE");
       ...
       createSet: function()
       {
           this.canvas.paper.setStart();
            ...
            shape.attr({"x":21.421875,"y":163.5,"text-anchor":"start","text":"74LS20","font-family":"\"Arial\"","font-size":16,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            ...
            // Label_NC1
            shape = this.canvas.paper.text(0,0,'NC1');
            shape.attr({"x":7.7734375,"y":60,"text-anchor":"start","text":"NC1","font-family":"\"Arial\"","font-size":8,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            shape.data("name","Label_NC1");
            
            // Label_1C
            shape = this.canvas.paper.text(0,0,'1C');
            shape.attr({"x":7.78125,"y":80.5,"text-anchor":"start","text":"1C","font-family":"\"Arial\"","font-size":8,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            shape.data("name","Label_1C");
            
            // Label_1D
            shape = this.canvas.paper.text(0,0,'1D');
            shape.attr({"x":8,"y":100.5,"text-anchor":"start","text":"1D","font-family":"\"Arial\"","font-size":8,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            shape.data("name","Label_1D");
            
            // Label_1Y
            shape = this.canvas.paper.text(0,0,'1Y');
            shape.attr({"x":8,"y":119.5,"text-anchor":"start","text":"1Y","font-family":"\"Arial\"","font-size":8,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            ...
            shape.attr({"x":73.3125,"y":142,"text-anchor":"start","text":"2Y","font-family":"\"Arial\"","font-size":8,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            shape.data("name","Label_2Y");
            
            // Label_2A
            shape = this.canvas.paper.text(0,0,'2A');
            shape.attr({"x":73.3125,"y":119.5,"text-anchor":"start","text":"2A","font-family":"\"Arial\"","font-size":8,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            shape.data("name","Label_2A");
            
            // Label_2B
            shape = this.canvas.paper.text(0,0,'2B');
            shape.attr({"x":73.3125,"y":100.5,"text-anchor":"start","text":"2B","font-family":"\"Arial\"","font-size":8,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            shape.data("name","Label_2B");
            
            // Label_NC2
            shape = this.canvas.paper.text(0,0,'NC2');
            shape.attr({"x":73.3125,"y":80.5,"text-anchor":"start","text":"NC2","font-family":"\"Arial\"","font-size":8,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            shape.data("name","Label_NC2");
            
            // Label_2C
            shape = this.canvas.paper.text(0,0,'2C');
            shape.attr({"x":73.3125,"y":62.5,"text-anchor":"start","text":"2C","font-family":"\"Arial\"","font-size":8,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            shape.data("name","Label_2C");
            
            // Label_2D
            shape = this.canvas.paper.text(0,0,'4B');
            shape.attr({"x":73.3125,"y":40.5,"text-anchor":"start","text":"2D","font-family":"\"Arial\"","font-size":8,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
            shape.data("name","Label_2D");
    ...
    C74LS20 = C74LS20.extend({
        ...
        calculate:function()
        {
            ...
            var D1 = this.getInputPort("Port_1D");
            ...
            var D2 = this.getInputPort("Port_2D");
        ...
        note: "Y = not (A and B and C and D)"
    });